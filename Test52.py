...
class Test52(unittest.TestCase):
    ...
    def test_52(self):
        ...
        driver.find_element_by_xpath("//*[@id='usersLink']").click()
        time.sleep(2)
        driver.find_element_by_xpath("//*[@id='tabUserRole']").click()
        driver.find_element_by_xpath("//*[@id='UserRole']/div[1]/div/button").click()
        driver.find_element_by_id("name").send_keys("XYZ")
        driver.find_element_by_xpath("//*[@id='UserRole_submit']/div[3]/div/button[1]").click()
        time.sleep(2)
