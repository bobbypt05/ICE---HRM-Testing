...
class Test17(unittest.TestCase):
    ...
    def test_17(self):
        ...
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Filter'])[1]/i[1]").click()
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Anyone'])[1]/following::button[1]").click()
