...
class Test56(unittest.TestCase):
    ...
    def test_56(self):
        ...
        driver.find_element_by_id("tabEmployeeSkill").click()
        driver.find_element_by_xpath("//*[@id='EmployeeSkill']/div[1]/div/button[1]").click()
        select = Select(driver.find_element_by_id('employee'))
        select.select_by_visible_text('IceHrm Employee')
