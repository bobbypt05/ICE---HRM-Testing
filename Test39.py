...
class Test34(unittest.TestCase):
    ...
    def test_34(self):
        ...
        driver.find_element_by_xpath('//*[@id="Client"]/div[1]/div/button').click()
        driver.find_element_by_id('name').send_keys("bobbypt05")
        select = Select(driver.find_element_by_id('status'))
        select.select_by_visible_text('Active')
        driver.find_element_by_xpath("//*[@id='Client_submit']/div/div[10]/div[1]/button[1]").click()
        time.sleep(2)
