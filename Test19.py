...
class Test19(unittest.TestCase):
    ...
    def test_19(self):
        ...
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Add New'])[1]/following::button[1]").click()
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='IceHrm Employee'])[3]/following::button[1]").click()
