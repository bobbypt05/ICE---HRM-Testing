...
class Test34(unittest.TestCase):
    ...
    def test_34(self):
        ...
        time.sleep(2)
        driver.find_element_by_id('tabEmployeeProject').click()
        driver.find_element_by_xpath('//*[@id="EmployeeProject"]/div[1]/div/button[1]').click()
        select1 = Select(driver.find_element_by_id("employee"))
        select1.select_by_visible_text("IceHrm Employee")
        select1 = Select(driver.find_element_by_id("project"))
        select1.select_by_visible_text("Project 1")
        driver.find_element_by_xpath("//*[@id='EmployeeProject_submit']/div/div[5]/div[1]/button[1]").click()
        time.sleep(2)
