...
class Test23(unittest.TestCase):
    ...
    def test_23(self):
        ...
        driver.find_element_by_id("tabEmployeeCertification").click()
        driver.find_element_by_xpath("//*[@id='EmployeeCertification']/div[1]/div/button[1]").click()
        select1 = Select(driver.find_element_by_id('employee'))
        select1.select_by_visible_text('IceHrm Employee')
        select2 = Select(driver.find_element_by_id('certification_id'))
        select2.select_by_value('1') 
        driver.find_element_by_xpath("//*[@id='EmployeeCertification_submit']/div/div[7]/div[1]/button[1]").click()
